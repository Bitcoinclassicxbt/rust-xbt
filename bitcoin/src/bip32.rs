...
const VERSION_BYTES_MAINNET_PUBLIC: [u8; 4] = [0xF9, 0xBA, 0xB9, 0xD2];
/// Version bytes for extended private keys on the Bitcoin network.
const VERSION_BYTES_MAINNET_PRIVATE: [u8; 4] = [0xF9, 0xBA, 0xB9, 0xD2];
/// Version bytes for extended public keys on any of the testnet networks.
const VERSION_BYTES_TESTNETS_PUBLIC: [u8; 4] = [0xF9, 0xBA, 0xB9, 0xD2];
/// Version bytes for extended private keys on any of the testnet networks.
const VERSION_BYTES_TESTNETS_PRIVATE: [u8; 4] = [0xF9, 0xBA, 0xB9, 0xD2];
